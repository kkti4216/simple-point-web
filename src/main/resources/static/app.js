...
async function loadBalance() {
    try {
        const response = await fetch(`/app/api/points/${currentUser}`);
...
async function loadHistory() {
    try {
        const response = await fetch(`/app/api/points/${currentUser}/history`);
...
async function addPoints() {
    ...
    try {
        const response = await fetch('/app/api/points/add', {
            method: 'POST',
...
async function usePoints() {
    ...
    try {
        const response = await fetch('/app/api/points/use', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                userId: currentUser,
